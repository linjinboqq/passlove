...
//bylinjinbo改密码
    ...
    @ResponseBody
    public String updatepassword(@RequestParam String password, @RequestParam String username, @RequestParam String JSESSIONID) throws Exception {
        JSONObject returnData = null; //返回信息
        int status = 400;
        try {
            returnData = new JSONObject(true);
