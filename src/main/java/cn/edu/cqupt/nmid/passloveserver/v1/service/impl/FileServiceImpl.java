...
import cn.edu.cqupt.nmid.passloveserver.util.ConstantPropertiesUtil;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            url = "https://"+ConstantPropertiesUtil.BUCKET_NAME + "." + ConstantPropertiesUtil.END_POINT.substring(7) + "/" + urlPath;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            // 关闭OSSClient。
