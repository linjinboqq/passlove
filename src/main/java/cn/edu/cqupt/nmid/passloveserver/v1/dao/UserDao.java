...
public interface UserDao {
    ...
    public int updatePassword(@Param("user") User user, @Param("password") String password);
    ...
    @Select("SELECT username FROM user_snumber where snumber=#{snumber}")
    String selectUserNameBysNumber(@Param("snumber")int snumber);
}
